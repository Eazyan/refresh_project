...
Revision ID: 3e11ca014af1
Revises: 
Create Date: 2025-07-28 03:27:25.984946
...
def upgrade() -> None:
    ...
    sa.Column('task_owner_id', sa.UUID(), nullable=True),
    ...
    op.create_index(op.f('ix_task_events_task_owner_id'), 'task_events', ['task_owner_id'], unique=False)
...
def downgrade() -> None:
    """Downgrade schema."""
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_index(op.f('ix_task_events_task_owner_id'), table_name='task_events')
